...
import { useGetServerStatus } from 'src/actions/monitoring';

import { V2InfoTip } from 'src/sections/overview-v2/v2-info-tip';

// ----------------------------------------------------------------------

const INFO = '등록된 서버 인스턴스의 실시간 가동 상태 및 최근 로그/에러 수';
...
function StatusDot({ status, tokens }) {
  ...
  return (
    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 0.75 }}>
      ...
      />
      <Box sx={{ fontSize: '0.7rem', color: tokens.text.secondary, textTransform: 'lowercase' }}>
...
export function WidgetServerStatus() {
